<?PHP
	...
	if(isset($_GET['mode']) && $_GET['mode'] == 'del')
	{
		...
		header("location:contactUs.php?page=".$_GET['page']);
	}
	/* =========== DELETE END ================ */
...
<!--
	...
	{
		document.frm.action='contactUs.php?Show='+id;
		document.frm.submit();
	}
	function del(uid,page)
	{
		...
		{
		   document.frm.action='contactUs.php?mode=del&id='+uid+'&page='+page;
		   document.frm.submit();
		}
	}
//-->
    ...
    <section id="widget-grid" class="">
      <div class="row">
		...
		<?PHP
			...
			$selectQuery = "SELECT * FROM ".CONTACT_US." ".$where_clause." ORDER BY `id` DESC";
