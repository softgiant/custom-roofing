...
//$baseUrl = $_SERVER['HTTP_HOST']."/lawlords/admin/ckfinder/userfiles/";
//$baseUrl = '/truck/admin/ckfinder/userfiles/';
//$baseUrl = '/douglas-brown/admin/js/plugin/ckfinder/userfiles/';$baseUrl = 'http://192.168.1.12/teamD/rajiv/andy/admin/js/plugin/ckfinder/userfiles/';
//$baseUrl = '/new-site/admin/js/plugin/ckfinder/userfiles/';
/*
