...
/*=========== UPDATE QUERY START ===========*/
	...
	{		
	  ...
	  if(!mysql_num_rows($search_rows)>0){			  
			...
			$large_upload_dir='../images/news_gallery/large/';
			$upload_dir='../images/news_gallery/';
			if($_FILES['file']['name']!="")
			{
		...
		$msg = "<font color='green'>News has been updated successfully.</font>";	
...
/*=========== SELECT QUERY START ===========*/
	if($_GET['PageID']!='') $page_details=$obj->runSql("SELECT * FROM ".NEWS." WHERE id = ".realStrip($_GET['PageID']));
/*=========== SELECT QUERY END ===========*/
        ...
        <article class="col-sm-12 col-md-12">
          ...
          <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
            <header> <span class="widget-icon"> <i class="fa fa-edit"></i> </span>
              <h2><?PHP echo($page_details['page_name']!='' ? $page_details['page_name'] : 'Add New News');?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  ...
                  <fieldset>
                    ...
                    <section>
                      ...
                      <div class="input input-file"> <span class="button">
                        ...
                        Browse</span>
                        <input type="text" name="txtHidden" onClick="javascript:document.getElementById('file').click();" placeholder="Photos for News" value="<?PHP echo $_POST['txtHidden']; ?>" >
						 <?PHP if($_GET['PageID']!=''){ ?>
                       <a href="delete.php?del=<?PHP echo $_POST['txtHidden']; ?>&PageID=<?php echo $_GET['PageID']; ?>&page=<?php echo $_GET['page']; ?>" ><i class="fa fa-delete"></i></a>
							<?php } ?>				
						</div>
                    </section>
