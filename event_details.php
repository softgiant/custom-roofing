<?PHP
	...
	$page_content=$obj->runSql("SELECT * FROM ".EVENT." WHERE `status`='Y' AND `url_title` = '".realStrip($get_page[$pi])."'");
	
	if(!$page_content) header("location:".DOMAIN_NAME.ERROR_PAGE);

//$page_content['template'] = 'blog.php'; 
$page_content['template'] = 'event.php';
           ...
           <div class="col-md-12 col-sm-12 col-xs-12">
             <section>
                 ...
                 <!------------------ starting section_content ---------------------->
                    <div class="section_content odd">
                       <div class="col-md-12 col-sm-12 col-xs-12">
						...
						<a class="html5lightbox" data-group="set1" data-thumbnail="<?PHP echo DOMAIN_NAME.'images/event_gallery/large/'.$page_content['dfile']; ?>" href="<?PHP echo DOMAIN_NAME.'images/event_gallery/large/'.$page_content['dfile']; ?>"><img src="<?PHP echo DOMAIN_NAME; ?>images/event_gallery/large/<?PHP echo $page_content['dfile']; ?>" alt="" class="img-responsive center-block"></a>
						</div>
                        	<div class="text-left">
							<!-- <h3 class="hfl"><?PHP //echo $page_content['page_name']; ?></h3> -->
                ...
                <div class="clearfix"></div>
                            ...
                            <p><span class="ddatte">Event Date:</span> <?PHP echo date('d/m/Y',strtotime($page_content['posted_date'])); ?> <?php echo date('g:iA',strtotime($page_content['event_time'])); ?></p>
